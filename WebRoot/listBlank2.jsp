...
<html>
  ...
  <body>
			 	 ...
			 	 <div>
				    <s:iterator value="%{list}" var="item">
				    	<ul class="list-group" style="list-style: none;">
				    		...
				    		<li><input type="hidden" id="bchapter" value= "<s:property value='#item[1]'/>" /></li>
				    		<li><input type="hidden" id="bid" value= "<s:property value='#item[2]'/>" /></li>
							...
							<li>
								<a href="${pageContext.request.contextPath }/blank_findById
								?cid=<s:property value='#item[0]'/>
								&bchapter=<s:property value='#item[1]'/>
								&bid=<s:property value='#item[2]'/>">修改</a>
								 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;								 
	...
	<script src="js/listblank.js"></script>
  </body>
</html>
