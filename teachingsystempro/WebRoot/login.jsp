...
<body>
	<header class="navbar navbar-dark navbar-static-top bd-navbar" role="banner">
	  ...
	  <nav class="nav navbar-nav navbar-right">
	     <a href="register.jsp"><button type="button" id="a" class="btn btn-warning-outline pull-right">注册</button></a>
	    </nav>
	</header>
	<div class="row img-rounded">	
	  ...
	  <form id="form1" action="login" method="post">
	    ...
	    <fieldset class="form-group">
	      ...
	      <input type="text" class="form-control" name="instructor.ipassword" id="formGroupExampleInput2" placeholder="password" required>
	      </fieldset>
