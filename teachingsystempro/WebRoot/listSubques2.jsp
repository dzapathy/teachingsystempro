...
<html>
  ...
  <body>  
				...
				<form method="post">
					<div id="up">
						...
						<div class="btn-group">
							...
							<button onclick="toSubquesAction()" class="btn btn-success">查看主观题</button>
						</div>												
					</div>
				</form>
					 <div>
				    <s:iterator value="%{list}" var="item">
				   	<ul style="list-style: none;">
				   		...
				   		<li><input type="hidden" id="suchapter" value= "<s:property value='#item[1]'/>" /></li>
				   		<li><input type="hidden" id="suid" value= "<s:property value='#item[2]'/>" /></li>
				   		<li>问题：&nbsp;&nbsp;<s:property value="#item[3]"/></li>
				   		<li>答案:&nbsp;&nbsp;<s:property value="#item[4]"/></li>
				   		<li>解释:&nbsp;&nbsp;<s:property value="#item[5]"/></li>
				   		<li>分数:&nbsp;&nbsp;<s:property value="#item[6]"/></li>
				   		<li><a href="${pageContext.request.contextPath }/play_media?media=<s:property value='#item[7]'/> ">播放媒体</a>  </li>
						<li>
							<a href="${pageContext.request.contextPath }/subques_findById
							?cid=<s:property value='#item[0]'/>
							&suchapter=<s:property value='#item[1]'/>
							&suid=<s:property value='#item[2]'/>">修改</a>
							 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				    ...
				    <c:choose> 
				       <c:when test="${list != null && list.size() > 0}">
							<a href="${pageContext.request.contextPath }/subques_list?
	...
	<script src="js/listsubques.js"></script>
  </body>
</html>
